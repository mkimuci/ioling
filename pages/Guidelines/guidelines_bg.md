...
1. Работен език
  ...
  * Изберете езика, с който се чувствате най-комфортно. Нито един специфичен работен език няма да Ви донесе каквото и да било предимство – на МОЛ всички езици се ползват с равноправен статут.
  ...
  * Трябва да напишете решенията си на съответния работен език. За части от Вашето решение можете да използвате и други от работните езици на текущата МОЛ, ако смятате, че това би ви позволило да обясните решението си по-добре. Въпреки това, като цяло не се препоръчва използването на други езици, тъй като рискувате да допуснете грешки и работата Ви да бъде оценена по-ниско.
1. Условия
  ...
  * Можете да запазите условията след приключване на състезанието, но трябва да предадете всичката си работа, която очаквате Журито да оцени. Поставете всичко необходимо за целта в плика, който ще Ви бъде предоставен.  Не поставяйте листовете с чернови или други листове, които не желаете да бъдат разгледани от Журито, или които нямат лепенка върху тях (вижте раздел 3).
...
1. Вашите решения
  ...
  * На всеки лист залепете лепенка с Вашето име и място в залата. На лепенката напишете номера на задачата и поредния номер на листа за съответната задача, пр. задача 3, лист 1/4, задача 3, лист 2/4, и т.н. (да се разбира първи лист от четири и т.н.). Само листове с лепенки върху тях ще бъдат оценявани от Журито. Предварително форматираните листове за отговори вече имат място, където да напишете съответната информация, така че не е необходимо да лепите лепенка върху тях. Ако изразходвате всичките си лепенки, просто запишете съответната информация отгоре на листа: име, място в залата, номер на задача, номер на лист по съответната задача.
...
1. Какво можете да си носите
  ...
  * Можете да носите допълнителни канцеларски материали (напр. линийка, маркери, гумичка).
  * За да носите нещо, което не е посочено в точки 4.-6., трябва да поискате одобрение от Журито. За да направите това или за да получите разяснение дали носенето на нещо е приемливо, помолете ръководителя на отбора си да се свърже с председателя на Журито.
1. Какво НЕ ТРЯБВА да носите
  ...
  * Не трябва да носите лаптопи, таблети, мобилни телефони, „смарт“ часовници или каквото и да е друго устройство, което би Ви позволило връзка с външния свят и/или интернет. или нещо друго, което би ви осигурило нечестно предимство пред другите участници. Състезател, у когото бъде открито такова устройство по време на състезанието, ще бъде незабавно дисквалифициран.
1. Влизане и напускане на залата
  ...
  * Ако имате нужда да напуснете временно залата, вдигнете ръка. Ще бъдете съпроводени от квестор.  Не се допуска едновременното напускане на стаята от повече от един от членовете на отбора, освен в случай на спешност. Постарайте се да не пречите на останалите участници.
...
1. Работен език:
  ...
  * Трябва да напишете решенията си на съответния работен език, избран от отбора. За части от Вашето решение можете да използвате и други от работните езици на текущата МОЛ, ако смятате, че това би ви позволило да обясните решението си по-добре. Въпреки това, като цяло не се препоръчва използването на други езици, тъй като рискувате да допуснете грешки и работата Ви да бъде оценена по-ниско. Един или повече участници от отбора имат правото да работят на избран от тях език по време на индивидуалното състезание, но по време на отборното състезание целият отбор трябва да работи на един език.
1. Условие
...
1. Приключване
  ...
  * Имайте предвид, че е възможно отборите от съседните стаи да са започнали по-късно от вас и е възможно още да работят.

Одобрено от Милена Венева, 21 юли 2026 г.