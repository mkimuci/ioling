...
1. Working language
  ...
  * You should choose the language in which you are most comfortable. There is absolutely no advantage to be gained from using any particular language: all working languages have equal status in IOL.
  ...
  * You should write your solutions in the same working language. You may use other working languages of the current IOL edition for parts of your solution, if you believe this would allow you to explain your solution better. However, you are generally discouraged from using other languages, as you risk introducing mistakes and losing marks.
1. The problem set
  ...
  * You may keep your copy of the problems afterwards, but you must hand in all paperwork that you want the Jury to mark (grade). You should put all of this in the envelope provided. Please do not add drafts or other paperwork that the Jury does not need to see, or that does not have a sticker on it (see section 3).
...
1. Your answer sheets
  ...
  * On each sheet attach a sticker which should show your name and seat number. On the sticker indicate the number of the problem, and the page sequence of that sheet within the problem, e.g. problem 3 sheet 1 out of 4, problem 3 sheet 2 out of 4, etc. (meaning first sheet of four, etc.). Only sheets with stickers on them will be marked by the Jury. Pre-formatted answer sheets already have a space for you to write your information, so you do not need to attach a sticker on these. If you run out of stickers, simply write this information on the top of the sheet: name, seat number, problem number, sheet number within the problem.
...
1. What you MUST NOT bring
  ...
  * You must not bring any laptop, tablet, mobile phone, smart watch or any other device which would enable you to contact the outside world or the internet, or any other item that would provide you with an unfair advantage over other contestants. Any contestant found with any such item in their possession during the contest will be immediately disqualified.
...
1. Working language
  ...
  * You should use the team working language for your solution. You may use other working languages of the current IOL edition for parts of your solution, if you believe this would allow you to explain your solution better. However, you are generally discouraged from using other languages, as you risk introducing mistakes and losing marks. One or more of the team members may have requested a different working language in the individual contest, but for the team contest you must all work in the same language.
1. The problem
...
1. Finishing up
  ...
  * Remember that the team next door may have started later than you, so they may still be working.

Approved by Dan-Mircea Mirea; July 20, 2026