...
1. Рабочий язык
  ...
  * Записывайте решения на том же рабочем языке. Вы можете использовать другие рабочие языки Международной олимпиады по лингвистике этого года для отдельных частей решения, если считаете, что это поможет вам лучше изложить решение.  Однако в целом использовать другие языки не рекомендуется, поскольку это может привести к ошибкам и потере баллов.
1. Комплект задач
...
1. Ваши решения
  ...
  * На каждый лист прикрепите стикер с вашим именем и номером места в аудитории. Отметьте на стикере номер задачи и номер этого листа в решении данной задачи, например: задача 3 лист 1/4, задача 3 лист 2/4 и т.д. (соответственно, первый лист из четырех и так далее). Жюри будет проверять только листы со стикерами. На заранее подготовленных бланках ответов уже предусмотрено место, куда можно вписать ваши данные, поэтому наклеивать на них стикер не нужно. Если у вас закончились стикеры, просто напишите эту информацию в верхней части листа: имя, номер места в аудитории, номер задачи, номер листа в решении задачи.
...
1. Что можно принести с собой
  ...
  * Вы можете взять с собой дополнительные канцелярские принадлежности (например, линейку, текстовыделители, ластик).
  * Чтобы принести любой другой предмет, не указанный в пунктах 4–6, необходимо получить разрешение жюри. Для этого или для уточнения, допустим ли конкретный предмет, попросите руководителя вашей команды связаться с председателем жюри.
1. Что НЕЛЬЗЯ приносить с собой
  ...
  * Запрещено приносить с собой ноутбуки, планшеты, мобильные телефоны, умные часы и любые другие устройства, дающие возможность связи с внешним миром или интернетом. или любой другой предмет, который дал бы вам несправедливое преимущество перед другими участниками. Любой участник, у которого в ходе соревнования будет обнаружено такое устройство, будет немедленно дисквалифицирован.
1. Вход и выход из помещения
  ...
  * Если вам нужно на время покинуть аудиторию, поднимите руку. Вас будет сопровождать дежурный. Одновременно покидать помещение разрешается только одному члену команды, за исключением чрезвычайных ситуаций.  Постарайтесь не беспокоить остальных участников.
...
1. Рабочий язык
  ...
  * Вы должны использовать этот язык для решения. Вы можете использовать другие рабочие языки Международной олимпиады по лингвистике этого года для отдельных частей решения, если считаете, что это поможет вам лучше изложить решение.  Однако в целом использовать другие языки не рекомендуется, поскольку это может привести к ошибкам и потере баллов. Кто-то из вашей команды мог запросить другой рабочий язык для индивидуального соревнования, но на командном соревновании вы все должны работать на одном языке.
1. Задача
...
1. Окончание работы
  ...
  * Помните, что команды в соседней комнате могли начать работу позже вас и, возможно, все еще работают.

Одобрено А.Ч. Пиперски 26.07.2026.