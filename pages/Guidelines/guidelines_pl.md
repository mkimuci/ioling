...
1. Język rozwiązywania zadań
  ...
  * Należy wybrać język, w którym czujecie się najpewniej. Użycie jakiegokolwiek konkretnego języka nie daje żadnej przewagi, wszystkie języki mają na Olimpiadzie taki sam status.
  ...
  * Rozwiązania należy pisać w tym samym języku. Dozwolone jest użycie innych języków roboczych aktualnej edycji IOL w częściach rozwiązania, jeżeli ma to ułatwić jego wytłumaczenie. Pisanie rozwiązań w języku innym niż własny nie jest jednak zalecane, ponieważ ewentualne pomyłki mogą skutkować utratą punktów.
1. Zestaw zadań
  ...
  * Możesz zatrzymać swój zestaw zadań, ale musisz oddać wszystkie kartki, które chcesz, żeby zostały ocenione.  Włóż je do przeznaczonej na nie koperty. Nie oddawaj brudnopisu ani żadnych innych kartek, które nie są przeznaczone do wglądu jury. Nie oddawaj kartek bez naklejki (patrz: sekcja 3).
...
1. Rozwiązania
  ...
  * Na każdą kartkę z rozwiązaniem nalep naklejkę z Twoim nazwiskiem i numerem miejsca. Na naklejce zapisz numer zadania i która jest to kartka w obrębie rozwiązania tego zadania, np. „zadanie 3, kartka 1/4”, „zadanie 3, kartka 2/4” itd. („kartka pierwsza z czterech” itd.). Przez jury ocenione zostaną wyłącznie te kartki, które opatrzono naklejką. Na kartach odpowiedzi z góry wyodrębniono miejsce na wpisanie swoich danych; nie jest więc potrzebne opatrywanie ich naklejką Jeśli zabraknie Ci naklejek, napisz własnoręcznie te informacje na górze strony (nazwisko, numer miejsca, numer zadania i która to kartka w obrębie jego rozwiązania).
...
1. Co możesz przynieść
  ...
  * Dozwolone jest posiadanie z sobą dodatkowych przyborów (linijki, flamastrów, gumki itp.).
  * Inne przedmioty niewymienione w punktach 4-6 muszą zostać zaakceptowane przez jurorów. Aby uzyskać taką akceptację lub ewentualnie zweryfikować, czy dany przedmiot jest dozwolony, proproś opiekuna swojej drużyny o skontaktowanie się w tej sprawie z przewodniczącym jury.
1. Czego przynieść nie wolno
  ...
  * Nie wolno wnosić laptopów, tabletów, telefonów komórkowych, smartwatchów ani innych urządzeń, które umożliwiają połączenie ze światem zewnętrznym lub Internetem, ani żadnych innych przedmiotów, które pozwalałyby na uzyskanie nieuczciwej przewagi nad innymi uczestnikami. Uczestnik, przy którym podczas zawodów znalezione zostanie takie urządzenie, będzie natychmiast zdyskwalifikowany.
...
1. Język rozwiązywania zadania
  ...
  * Tego samego języka powinniście używać w swoim rozwiązaniu. Dozwolone jest użycie innych języków roboczych aktualnej edycji IOL w częściach rozwiązania, jeżeli ma to ułatwić jego wytłumaczenie. Pisanie rozwiązań w języku innym niż własny nie jest jednak zalecane, ponieważ ewentualne pomyłki mogą skutkować utratą punktów. O ile podczas zawodów indywidualnych poszczególni członkowie drużyny mogli posługiwać się różnymi językami, podczas zawodów drużynowych musicie pracować wszyscy w tym samym języku.
1. Zadanie
