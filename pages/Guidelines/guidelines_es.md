...
1. Idioma de trabajo
  ...
  * Debes elegir el idioma en el que te sientas más cómodo/a. No hay absolutamente ninguna ventaja en usar un idioma en particular: todos los idiomas de trabajo tienen el mismo estatus en la IOL.
  ...
  * Escribe tus soluciones en el mismo idioma de trabajo. Se permite acudir a otros idiomas de trabajo de la edición actual de IOL en partes de tu solución, si consideras que es necesario para explicar tu solución con más claridad. Sin embargo, por lo general no se recomienda usar otros idiomas, ya que corres el riesgo de introducir errores y perder puntos.
1. El conjunto de problemas
  ...
  * Puedes guardar tu copia de los problemas después de la competencia, pero debes entregar todos los papeles que deseas que el jurado corrija. Debes poner todo esto en el sobre suministrado. Por favor, no incluyas borradores ni otros documentos que no quieres que sean vistos por el jurado o que no tengan una etiqueta (véase la sección 3).
...
1. Tus hojas de respuestas
  ...
  * En cada hoja pega una etiqueta que debe mostrar tu nombre y número de asiento. En la etiqueta, escribe el número del problema y la numeración de la página de esa hoja dentro del problema, p. ej., “problema 3, hoja n°. 1 de 4”, “problema 3, hoja n°. 2 de 4”, etc. (que significa “la primera hoja de cuatro del problema 3”, etc.). El jurado evaluará apenas las hojas que tengan etiquetas. Las hojas de respuestas preformateadas ya cuentan con un espacio para que escribas tus datos, por lo que no es necesario que les pegues una etiqueta. Si te quedas sin etiquetas, simplemente escribe esta información en la parte superior de la hoja: nombre, número de asiento, número de problema, numeración de la hoja dentro del problema.
...
1. Qué puedes traer
  ...
  * Puedes traer artículos de papelería adicionales (p. ej., regla, marcadores, borrador).
  * Para traer cualquier otro artículo que no figure en los ítems 4 a 6, debes solicitar la autorización del jurado. Para ello, o para averiguar si un artículo específico es aceptable, pide al líder de tu equipo que se comunique con el presidente del jurado.
1. Lo que NO DEBES traer
  ...
  * No se permite traer ninguna computadora portátil, tableta, teléfono móvil, reloj inteligente o cualquier otro dispositivo que te permita comunicarte con el mundo exterior o con Internet, tampoco se permite que traigas cualquier otro objeto que te brinde una ventaja injusta sobre los demás participantes. Cualquier participante que se encuentre con cualquiera de tales objetos en su poder durante la competencia será descalificado/a inmediatamente.
...
1. Idioma de trabajo
  ...
  * Utilicen el idioma de trabajo del equipo para su solución. Se permite acudir a otros idiomas de trabajo de la edición actual de IOL en partes de tu solución, si consideras que es necesario para explicar tu solución con más claridad. Sin embargo, por lo general no se recomienda usar otros idiomas, ya que corres el riesgo de introducir errores y perder puntos. Uno o más de los miembros del equipo pueden haber solicitado un idioma de trabajo diferente en la competencia individual, pero para la competencia del equipo todos deben trabajar en el mismo idioma.
1. El problema
...
1. Al final
  ...
  * Recuerden que el equipo de al lado puede haber comenzado más tarde que ustedes, por lo que aún pueden estar trabajando.

Aprobado por Andrey Nikulin el 24 de julio de 2026.