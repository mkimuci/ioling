...
1. Töökeel
  ...
  * Te peaksite valima keele, milles tunnete end kõige mugavalt. Mingi kindla keele kasutamine ei anna mingisugust eelist: kõikidel töökeeltel on IOL-il võrdne staatus.
  ...
  * Te peaksite kirjutama oma lahendused samas töökeeles. Teil on lubatud kasutada teisi mineva IOL-i töökeeli oma lahenduse osades, kui te arvate, et niimoodi saate oma lahenduse selgemaks teha. Teiste keelte kasutamine on siiski ebasoovitatav, kuna te riskite vigade tegemisega ja punktide kaotusega.
1. Ülesandekomplekt
  ...
  * Te võite pärast võistluse lõppu jätta enda kätte oma ülesandekomplekti, kuid peate üle andma kõik paberid, mida soovite lasta žüriil hinnata. Pange kõik need paberid  teile antud ümbrikusse. Ärge lisage mustandit ega teisi pabereid, mida te ei soovi žüriile näidata või milledel ei ole kleepsu (vt sektsioon 3).
...
1. Teie vastuslehed
  ...
  * Igale lehele kleepige kleeps, kuhu on kirjutatud teie nimi ja istekoht. Märkige kleepsul ülesande number ja mitmes leht see vastavas ülesandes on, nt ülesanne 3, lehekülg 1/4, ülesanne 3, lehekülg 2/4 jne (st esimene leht neljast jne.). Ainult kleepsuga lehed saavad žürii poolt hindatud. Ettevalmistatud vastuste lehtedel on juba ette nähtud koht, kus oma andmed kirjutada. Järelikult ei pea Te nende peale kleepsu kleepima. Kui teil saavad kleepsud otsa, kirjutage see info lihtsalt lehe päisesse: nimi, istekoha number, ülesande number, lehe number vastavas ülesandes.
...
1. Mida tohib kaasa võtta
  ...
  * Te võite kaasa võtta ka erinevad kirjutus- ja joonistusvahendid (nagu tekstimarkerid, kustukumm, joonlaud).
  * Et kaasa võtta midagi, mida ei ole punktides 4.-6. loendatud, vajate te žürii heakskiitu. Et see saada või lihtsalt kinnitada, kas mõni ese on sobilik, paluge oma meeskonna juhendajalt, et ta pöörduks selle küsimusega žürii esimehe poole.
1. Mida EI TOHI kaasa võtta
  ...
  * Te ei tohi kaasa võtta sülearvutit, tahvelarvutit, mobiili, nutikella või muud seadet, mis võimaldaks teil kontakteeruda välismaailmaga või pääseda internetti, ega ükskõik millist teist esemet, mis annaks teile ebaausat eelist võrreldes teiste osalejatega. Iga osaleja, kellel võistluse ajal leitakse taoline ese, diskvalifitseeritakse otsekohe.
...
1. Võistluskeel
  ...
  * Te peaksite kasutama lahenduses oma meeskonna töökeelt. Teil on lubatud kasutada teisi mineva IOL-i töökeeli oma lahenduse osades, kui te arvate, et niimoodi saate oma lahenduse selgemaks teha. Teiste keelte kasutamine on siiski ebasoovitatav, kuna te riskite vigade tegemisega ja punktide kaotusega. Mõni meeskonnaliikmetest võib olla palunud individuaalvõistluse jaoks teist töökeelt, kuid meeskonnavõistlusel peate kõik töötama samas keeles.
1. Ülesanne
