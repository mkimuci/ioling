...
1. Arbeitssprache
  * Jede Teilnehmerin und jeder Teilnehmer wählt seine Arbeitssprache aus den Angebotenen bei der Anmeldung zur Olympiade aus. Diese Wahl kann normalerweise nicht später als zwei Wochen vor Beginn der Olympiade geändert werden.
  * Du solltest die Sprache wählen, in der du dich am wohlsten fühlst. Es gibt absolut keinen Vorteil bei der Verwendung einer bestimmten Sprache: Alle Arbeitssprachen haben bei IOL den gleichen Status.
  ...
  * Du solltest deine Lösungen in der gleichen Arbeitssprache schreiben. Du darfst für Teile deiner Lösung andere Arbeitssprachen der aktuellen IOL-Ausgabe verwenden, wenn du glaubst, dass du dadurch deine Lösung besser erklären kannst. Es gibt keinen Vorteil, wenn man etwas anderes tut, und man riskiert, Fehler zu machen und Punkte zu verlieren.
1. Der Aufgabensatz
  ...
  * Du kannst deine Kopie des Aufgabensatzes im Anschluss behalten, du musst jedoch alle Unterlagen einreichen, die die Jury bewerten soll. Du solltest das alles in den mitgelieferten Umschlag legen. Bitte füge keine Entwürfe oder sonstige Unterlagen ein, die die Jury nicht sehen muss, oder die keine Aufkleber tragen (siehe Abschnitt 3)
...
1. Dein Antwortbogen
  ...
  * Versieh jedes Blatt mit einem Aufkleber, der deinen Namen und deine Sitznummer enthalten sollte. Gib auf dem Aufkleber die Nummer der Aufgabe und die Seitenreihenfolge des jeweiligen Blattes innerhalb der konkreten Aufgabe an: z.B. Aufgabe 3 Blatt 1 von 4, Aufgabe 3 Blatt 2 von 4, etc. (d.h. erstes von insgesamt vier Blättern, etc.). Nur Blätter mit Aufklebern wird die Jury bewerten. Vorformatierte Antwortblätter haben bereits ein Feld, in das du deine Angaben eintragen kannst, sodass du auf diesen keinen Aufkleber anbringen musst. Wenn dir die Aufkleber ausgehen, schreibe einfach diese Informationen oben auf das Blatt: Name, Sitznummer, Aufgabennummer, Blattnummer innerhalb der Aufgabe.
...
1. Was du mitbringen kannst
  ...
  * Du darfst zusätzliche Schreibwaren mitbringen (zB. Lineal, Textmarker, Radiergummi).
  * Um andere nicht in den Punkten 4.-6. aufgeführte Gegenstände mitzubringen, musst du die Genehmigung der Jury erhalten. Um das zu tun, oder um aufzuklären, ob ein bestimmter Gegenstand erlaubt ist, bitte deine Teamleitung, sich an den/die Vorsitzende·n zu kontaktieren.
1. Was du NICHT mitbringen darfst
  ...
  * Du darfst keinen Laptop, kein Tablett, kein Handy, keine Smartwatch oder anderes Gerät mitbringen, das dich ermöglicht, die Außenwelt oder das Internet zu kontaktieren, sowie keine andere Gegenstände, die dir einen ungerechten Vorteil gegenüber anderen Teilnehmern verschaffen würden. Jeder Teilnehmer, der während des Wettbewerbs mit einem solchen Gegenstand in seinem Besitz gefunden wird, wird sofort disqualifiziert.
...
1. Arbeitssprache
  ...
  * Ihr müsst die Teamarbeitssprache bei der Bearbeitung der Aufgabe verwenden. Du darfst für Teile deiner Lösung andere Arbeitssprachen der aktuellen IOL-Ausgabe verwenden, wenn du glaubst, dass du dadurch deine Lösung besser erklären kannst. Es gibt keinen Vorteil, wenn man etwas anderes tut, und man riskiert, Fehler zu machen und Punkte zu verlieren. Eines oder mehrere der Teammitglieder können im Einzelwettbewerb eine andere Arbeitssprache angefordert haben, aber für den Gruppenwettbewerb müssen alle in derselben Sprache arbeiten.
1. Die Aufgabe
...
1. Fertigstellung
  ...
  * Denkt daran, dass das Team von nebenan möglicherweise später als ihr begonnen hat, so dass da möglicherweise noch gearbeitet wird.

Genehmigt: Eimear McKnight, 21 Juli 2026