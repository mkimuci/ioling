...
1. Çalışma Dili
  ...
  * Çözümlerinizi de aynı dilde yazmalısınız. Çözümünüzü daha iyi açıklamanıza yardımcı olacağını düşünüyorsanız, çalışmanızın bazı kısımlarında bu yılki IOL'da kullanılan başka dilleri de kullanabilirsiniz Aksini yapmanızın hiçbir avantajı yoktur, ve tersine hatalarınızı göstererek puan kaybedebilirsiniz.
1. Problem Seti
  * Problem setinizde istediğiniz sırada çözebileceğiniz 5 farklı problem bulunur. Bir yarışmacı birden fazla problem kağıdı alamaz, lütfen talep etmeyiniz.
  * Yarışmanın süresi 6 (altı) saattir.
  * Yarışma sonunda problemleri alabilirsiniz, jürinin değerlendireceği tüm çözümleri teslim etmelisiniz. Çözümlerinizi size verilen zarfa koyunuz, müsvette çözümleriniz sizde kalabilir. Üzerinde etiket (Bölüm 3'e bakınız) bulunmayan veya Jürinin incelemesine gerek duyulmayan taslak veya diğer kağıtları teslim etmeyiniz
  * Problemler hata olmaması için dikkatlice kontrol edilmiştir, herhangi bir problemde hata olduğunu düşünüyorsanız lütfen elinizi kaldırın ve gözetmenin biri bilgilendirin. Ayrıca Jüriyi bilgilendirip, kendi dilinizde cevap almanız zaman alabilir, bu süre zarfında başka bir soru üzerinde çalışabilirsiniz.
  ...
  * Bütün sorular yazarak sorulmalıdır. Gözetmenler sorularınızı ana dilinizde yazmanız için size kağıt verecektir. Farklı problemlerle ilgili sorular farklı kağıtlara yazılmalıdır çünkü büyük ihtimalle farklı problemlerin farklı Jüri üyeler tarafından cevaplanması muhtemeldir (genellikle Jüri başkanı veya problemin yazarı cevaplayacaktır). Soruların cevaplarını kendi anadilinizde alacaksınız. 
...
1. Cevap kağıdı
  * Problem cümlelerini kopyalamayınız.
  * Her problemin çözümünü farklı kağıt(lar)da yazınız. Her problem farklı bir jüri üyesi tarafından değerlendirileceği için aynı kağıt üzerinde birden fazla problem cevaplanmamalıdır.
...
1. Yanınızda ne getirmemelisiniz?
  ...
  * Yanınızda dış dünya ile bağlantı kurabileceğiniz laptop bilgisayar, tablet, cep telefonu, akıllı saat veya benzer herhangi bir aygıt getirmeniz yasaktır. Diğer yarışmacılara karşı haksız avantaj sağlayabilecek herhangi bir malzemenin getirilmesi yasaktır Bu sayılanlardan herhangi birine sahip olduğu gözlenen yarışmacı, yarışmadan diskalifiye edilir.
...
1. Anket
  ...
  * Ankette cevapladığınız problemlerle alakalı sorular olacak. Bu bilgiler jüri üyelerinin problemlerin uygunluğuna karar vermeleri için yararlı olacaktır.
  * Ankette ayrıca sizin en çok beğendiğiniz problem sorulacaktır.
...
1. Yarışma Dili
  * Takımınız problemi sadece tek bir dilde alacaktır.
  * Takımınızın çalıştığı dili çözüm için kullanmalısınız. Çözümünüzü daha iyi açıklamanıza yardımcı olacağını düşünüyorsanız, çalışmanızın bazı kısımlarında bu yılki IOL'da kullanılan başka dilleri de kullanabilirsiniz Aksini yapmanızın hiçbir avantajı yoktur, ve tersine hatalarınızı göstererek puan kaybedebilirsiniz. Bireysel yarışma için bazı takım üyeleri farklı dillerde çalışmayı tercih etmiş olabilir, ama takım yarışması için tek bir çözüm dili seçilmelidir.
1. Problem
...
1. İş birliği
  ...
  * Takımınız için yarışma süresince ayrı oda da ayrılacaktır, özellikle pencereler açıksa yan odalardaki takımların tartışmanızı duyabileceğini ve / veya çok gürültülü olmanız durumunda rahatsız olabileceğini bilmelisiniz.
