...
1. Língua de trabalho
  ...
  * Você deve escrever suas soluções nesta mesma língua de trabalho. Você pode usar outras línguas de trabalho da edição atual da IOL para escrever partes da sua solução, se você acreditar que isso o permitirá de explicar melhor a sua solução. Entretanto, este uso de outras línguas nao é encorajado, já que você pode correr o risco de introduzir imprecisões e perder pontos.
1. O conjunto de problemas
  ...
  * Você pode ficar com a sua cópia dos problemas posteriormente, mas deve entregar todas as folhas que deseje que o júri corrija. Você deve colocar todo esse material no envelope fornecido. Pedimos que não inclua rascunhos ou outros papeis que o júri não precise ver, ou que não haja adesivo nele (veja seção 3). 
...
1. O que você pode trazer
  ...
  * É permitido trazer seus próprios materiais de papelaria (por exemplo, régua, marcador de texto, borracha).
  * Para portar qualquer outro item não listado nos pontos 4 a 6, é necessário pedir autorização prévia ao júri. Para fazê-lo, ou obter clarificação sobre algum item específico ser ou não permitio, peça ao seu team leader para entrar em contato com o coordenador do júri. 
1. O que você NÃO DEVE trazer
  ...
  * Não é permitido trazer laptop, tablet, celular, smart watch ou qualquer outro dispositivo que permita entrar em contato com o mundo exterior ou acessar a internet,  nem qualquer outro item que traga vantagem tangível sobre os demais competidores.  Qualquer participante encontrado com um item desses em sua posse durante a prova será imediatamente desclassificado/a.
...
1. Língua de trabalho
  ...
  * Vocês devem usar a língua de trabalho da equipe para escrever sua solução. Você pode usar outras línguas de trabalho da edição atual da IOL para escrever partes da sua solução, se você acreditar que isso o permitirá de explicar melhor a sua solução. Entretanto, este uso de outras línguas nao é encorajado, já que você pode correr o risco de introduzir imprecisões e perder pontos. Um ou mais dos membros da equipe podem ter solicitado uma língua de trabalho diferente na prova individual, mas todos devem trabalhar na prova de equipe usando a mesma língua.
1. O problema
...
1. Ao final
  ...
  * Lembre-se de que a equipe ao lado pode ter começado mais tarde que vocês e pode ainda estar trabalhando.

Aprovado por Bruno L'Astorina em 21 de julho de 2026