...
1. Soutěžní jazyk
  ...
  * Zvolte si jazyk, v němž jste si nejjistější. Žádný z jazyků není jakkoliv zvýhodněný: všechny soutěžní jazyky mají na IOL stejný status.
  ...
  * Řešení byste měli psát v soutěžním jazyce, ve kterém jste žádali zadání. Smíte použít jiné soutěžní jazyky z aktuálního ročníku IOL pro části svých řešení, pokud věříte, že vám umožní vaše řešení lépe vysvětlit. Obecně však není použití jiných jazyků doporučováno, jelikož riskuje chyby a ztrátu bodů.
1. Zadání soutěže
  ...
  * Po skončení soutěže si zadání můžete nechat, je ale nutné odevzdat všechny papíry s řešením, které chcete ohodnotit. Všechna řešení odevzdejte v připravené obálce. Nepříkládejte prosím řešení nanečisto ani jiné papíry, které porota nepotřebuje vidět, nebo které na sobě nemají nálepku (viz sekce 3).
...
1. Řešení úloh
  ...
  * Každý list s řešením označte nálepkou s vaším jménem a číslem místa. Na nálepku napište číslo úlohy a pořadové číslo listu v rámci úlohy, např. Úloha 3 List 1 z(e) 4, Úloha 3 List 2 z(e) 4 atd. (tedy první list ze čtyř atd.). Porota bude hodnotit pouze listy s nálepkou Předpřipravené listy pro odpovědi na sobě již mají místo pro vaše informace, proto je není třeba označovat nálepkou Dojdou-li vám nálepky, napište následující informace přímo do hlavičky listu: jméno, číslo místa, číslo úlohy, pořadí listu v rámci úlohy.
...
1. Co si smíte vzít s sebou
  ...
  * Smíte si přinést dodatečné kancelářské potřeby (např. pravítko, zvýrazňovače, gumu).
  * Pokud si chcete přinést jakýkoliv jiný přemět, který není popsaný v bodech 4.-6., je nutné, aby jej prvně schválila porota. V takovém případě nebo pokud chcete zjistit, zda je konkrétní předmět přísputný, poproste svého vedoucího výpravy, aby oslovil předsedu poroty.
1. Co si NESMÍTE brát s sebou
  ...
  * Nesmíte u sebe mít notebook, tablet, mobilní telefon, chytré hodinky, ani jiné zařízení, které umožňuje komunikaci s okolním světem nebo přístup na internet, ani jakýkoliv jiný předmět, který by vás neférově zvýhodnil oproti ostatním soutěžícím. Soutěžící, u nichž bude takové zařízení zjištěno během soutěže, budou okamžitě diskvalifikováni.
...
1. Soutěžní jazyk
  ...
  * Řešení byste měli psát v soutěžním jazyce vašeho týmu. Smíte použít jiné soutěžní jazyky z aktuálního ročníku IOL pro části svých řešení, pokud věříte, že vám umožní vaše řešení lépe vysvětlit. Obecně však není použití jiných jazyků doporučováno, jelikož riskuje chyby a ztrátu bodů. Může se stát, že někteří členové týmu si pro individuální soutěž zvolí odlišný jazyk, týmovou soutěž je ale nutno řešit v jednom jazyce.
1. Zadání
...
1. Odevzdání řešení
  ...
  * Pamatujte, že týmy ve vedlejších místnostech mohly začít s řešení úlohy později než vy, a mohou tedy stále pracovat.

Schválil: Jan Petr, 22. července 2026